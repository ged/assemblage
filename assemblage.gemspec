# -*- encoding: utf-8 -*-
# stub: assemblage 0.1.pre20180402134517 ruby lib

Gem::Specification.new do |s|
  s.name = "assemblage".freeze
  s.version = "0.1.pre20180402134517"
  ...
  s.files = [".document".freeze, ".editorconfig".freeze, ".rdoc_options".freeze, ".simplecov".freeze, "ChangeLog".freeze, "History.md".freeze, "LICENSE.txt".freeze, "Manifest.txt".freeze, "README.md".freeze, "Rakefile".freeze, "bin/assemblage".freeze, "data/assemblage/migrations/20180314_initial.rb".freeze, "lib/assemblage.rb".freeze, "lib/assemblage/auth.rb".freeze, "lib/assemblage/cli.rb".freeze, "lib/assemblage/command/create_server.rb".freeze, "lib/assemblage/command/create_worker.rb".freeze, "lib/assemblage/command/start_server.rb".freeze, "lib/assemblage/db_object.rb".freeze, "lib/assemblage/mixins.rb".freeze, "lib/assemblage/server.rb".freeze, "lib/assemblage/worker.rb".freeze, "spec/assemblage/auth_spec.rb".freeze, "spec/assemblage/mixins_spec.rb".freeze, "spec/assemblage/server_spec.rb".freeze, "spec/assemblage_spec.rb".freeze, "spec/spec_helper.rb".freeze]
